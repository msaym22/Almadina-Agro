...
import Loading from '../../components/common/Loading';
import { fetchCustomerById } from '../../features/customers/customerSlice'; // Corrected import path for fetchCustomerById
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="bg-white rounded shadow p-6">
        <h1 className="text-2xl font-bold mb-4">{currentCustomer.name}</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p><span className="font-semibold">Contact:</span> {currentCustomer.contact}</p>
            <p><span className="font-semibold">Address:</span> {currentCustomer.address}</p>
            <p><span className="font-semibold">Credit Limit:</span> PKR {currentCustomer.creditLimit}</p>
            <p><span className="font-semibold">Outstanding Balance:</span> PKR {currentCustomer.outstandingBalance}</p>
          </div>
        ...
        <div className="mt-6">
          ...
          <Link
            to="/customers"
            className="ml-4 inline-block bg-gray-300 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-400 transition-colors"
          >
            Back to List
          </Link>
        </div>
